	...
	<div id="content-head">
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on April 7, 2023 at 12:06 pm			</p>
		</xsl:if>
	</div>
</xsl:template>
...
Object Caching 7/10 objects using apc
Page Caching using apc (Requested URI contains query) 
Database Caching using apc

Served from: cosmeticsenvogue.eclipse1803.com @ 2023-04-07 12:06:33 by W3 Total Cache
-->